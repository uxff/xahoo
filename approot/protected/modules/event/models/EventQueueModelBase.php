...
/**
 * This is the model class for table "fh_event_queue".
 *
 * The followings are the available columns in table 'fh_event_queue':
 * @property string $id
 ...
 */
class EventQueueModelBase extends CActiveRecord
{
	/**
