<?php
class MemberPointsHistoryModel extends MemberPointsHistoryModelBase
{
    const TYPE_GAIN     = 1;    // 获赠
    const TYPE_CONSUME  = 2;    // 消费
        ...
        public function relations() {
                $curRelations = array(
                    'rule' => array(self::HAS_ONE, 'PointsRuleModel', '', 'on' => 'rule.rule_id = t.rule_id'),
                );
         ...
         * @return MemberPointsHistoryModel the static model class
         */
