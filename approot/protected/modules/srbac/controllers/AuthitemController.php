...
class AuthitemController extends SBaseController {
        ...
        private function _getTheRoles() {
                ...
                $this->renderPartial('tabViews/userAjax', array('model' => $model, 'userid' => $userid, 'data' => $data, 'message' => $this->_getMessage()), false, true);
        }
        ...
        private function _getTheTasks() {
                ...
                $this->renderPartial('tabViews/roleAjax', array('model' => $model, 'name' => $name, 'data' => $data, 'message' => $this->_getMessage()), false, true);
        }
        ...
        private function _getTheOpers() {
                ...
                $this->renderPartial('tabViews/taskAjax', array('model' => $model, 'name' => $name, 'data' => $data, 'message' => $this->_getMessage()), false, true);
        }
                ...
                if (isset($_POST['AuthItem'])) {
                        ...
                        try {
                                if ($model->save()) {
                                        ...
                                        Yii::app()->user->setFlash('updateSuccess', "'" . $model->name . "' " .
                                ...
                                Yii::app()->user->setFlash('updateError', Helper::translate('srbac', 'Error while creating')
                                        . ' ' . $model->name . "<br />" .
        ...
        public function actionConfirm() {
                $this->renderPartial('manage/show', array('model' => $this->loadAuthItem(), 'updateList' => false, 'delete' => true), false, true);
        }
        ...
        public function actionList() {
                ...
                //Get selected name
                $selectedName = Yii::app()->request->getParam('name', Yii::app()->user->getState("selectedName"));
        ...
        public function actionScan() {
                ...
                $this->renderPartial("manage/createItems", array("actions" => $controllerInfo[0],
                    ...
                    "allowed" => $controllerInfo[1]), false, true);
        }
        ...
        public function actionAutoDeleteItems() {
                ...
                foreach ($actions as $key => $action) {
                        ...
                        if ($auth !== null) {
                                ...
                                $message .= "<div style='color:red;font-weight:bold'>" . Helper::translate('srbac', 'Error while deleting')
                                        . ' ' . $action . "</div>";
                        }
                }
                        ...
                        foreach ($tasks as $key => $taskname) {
                                ...
                                try {
                                        if ($auth->save()) {
                                                ...
                                                $message .= "<div style='color:red;font-weight:bold'>" . Helper::translate('srbac', 'Error while creating')
                                                        . ' ' . $auth->name . '<br />' .
