...
//        }
        ...
        public function actionPost() {
                ...
                if (!is_null($upfile)) {
                        ...
                        if (preg_match('/' . $imagetype . '/', $up_rule)) {
                                ...
                                if ($upfile->saveAs($up_dir['ori'] . $news_name)) {
                                        ...
                                        foreach ($up_dir['thumb'] as $key => $value) {
                                                ...
                                                list($wid, $wei) = explode("x", $this->_config['task'][$key]);
...
//                }
                ...
                foreach ($this->_config['task'] as $key => $value) {
                        $rtpath['thumb'][$key] = $paths[$key] = $root_folder . DIRECTORY_SEPARATOR . date("Ym") . DIRECTORY_SEPARATOR . $value . DIRECTORY_SEPARATOR;
                }
