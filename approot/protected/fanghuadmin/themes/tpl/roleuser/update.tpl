<div class="page-content-area">
        <div class="page-header">
                                <h1> <a href="backend.php?r=roleUser">用户角色管理</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 编辑 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                        ...
                        <form class="form-horizontal" id="roleUser-form" role="form" action="backend.php?r=roleUser/update&id={$model[$primaryKey]}" method="POST">
