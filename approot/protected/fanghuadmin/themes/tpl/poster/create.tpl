...
<div class="page-content-area">
  <div class="page-header">
    <h1> <a href="fanghuadmin.php?r=poster">海报管理</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 海报配置 </small> </h1>
    {*
  ...
  <div class="row">
    <div class="col-xs-12"> 
      <form class="form-horizontal"  id="poster_form" role="form" onsubmit="return check_form_two();" action="fanghuadmin.php?r=Poster/Insert" method="POST"  autocomplete="off">
        <br />
            ...
            <div class="form-group col-xs-6">
              ...
              <div class="col-sm-8">
                <select id="poster_accounts_id" name="poster[accounts_id]" class="col-xs-12 col-sm-12">
                  ...
                  <option value='{$project['id']}'>{$project['accounts_name']}</option>                                          
                  {/foreach}
                </select>
              </div>
        ...
        <div class="box_base poster_baseinfo clearfix">
          <div class="col-xs-12">
            ...
            <div class="form-group col-xs-6">
              <label class="col-sm-3 control-label no-padding-right" for="highest_withdraw_sum">最高提现金额*</label>
              <div class="col-sm-8">
              ...
              <div class="col-sm-9">
                        <div class="input-group lablediv1" style="width:304px;" style="float:right;">
                            <input placeholder="请选择日期" type="text" class="form-control year-picker create_time_start" data-date-format="yyyy-mm-dd"
                                   ...
                                   class="col-xs-10 col-sm-5" value="{$poster['valid_begintime']}"/>
                            ...
                            <input placeholder="请选择日期" type="text" class="form-control year-picker create_time_end" data-date-format="yyyy-mm-dd"
                                   ...
                                   class="col-xs-10 col-sm-5" value="{$poster['valid_endtime']}"/>
                            <span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
                        </div>
              </div>
              <div class="col-sm-1"> <span class="help-inline middle" id="advert_title_em_"> </span> </div>
        ...
        <div class="box_base poster_baseinfo clearfix">
          <div class="col-xs-12">
            <div class="form-group col-xs-6">
              ...
              <div class="col-sm-9">
                        <div class="input-group lablediv1" style="width:304px;" style="float:right;">
                            <textarea name="poster[poster_rules]" id="poster_rules" cols="80" rows="5"></textarea>
                        </div>
              </div>
          ...
          <div class="col-xs-9">
              ...
              <div class="col-xs-10">
                  <div class="uploader-container-single">
                    ...
                    <div class="file-item thumbnail" style="width:100px; height:100px; overflow:hidden"><img src="{$poster['photo_pic']}" class="upload_img"><span class="success"></span></div>
                    </div>
                    <div>
                  ...
                  <input type="hidden" id="board1_pic" name="poster[photo_pic]" size="60" maxlength="200" class="col-xs-10 col-sm-5 load_img_f" value="{$poster['photo_pic']}" />
              </div>
            </div>
          </div>
        </div>
