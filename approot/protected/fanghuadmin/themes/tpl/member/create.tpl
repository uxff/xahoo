...
<div class="page-content-area">
        <div class="page-header">
                                <h1> <a href="fanghuadmin.php?r=member">Member</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 新增 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                    ...
                    <form class="form-horizontal" id="member-form" role="form" action="fanghuadmin.php?r=member/create"
                          method="POST">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7"><input type="text" id="Member_member_account"
                                                         ...
                                                         class="col-xs-10 col-sm-5" value="{$dataObj.member_account}"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7"><input type="text" id="Member_member_password"
                                                         ...
                                                         class="col-xs-10 col-sm-5" value="{$dataObj.member_password}"/>
                            </div>
                            <div class="col-sm-2"><span class="help-inline middle"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2"><span class="help-inline middle" id="Member_member_from_em_">  </span>
                            </div>
                        </div>
                        {*<div class="form-group">*}
                            {*<label class="col-sm-2 control-label no-padding-right"*}
                        ...
                        {*<div class="form-group">*}
                            ...
                            {*<div class="col-sm-2"><span class="help-inline middle" id="Member_parent_id_em_">  </span>*}
                            {*</div>*}
                        {*</div>*}
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right"
                                   for="Member_member_level_id">会员等级ID</label>

                            <div class="col-sm-7"><input type="text" id="Member_member_level_id"
                                                         name="Member[member_level_id]" size="60" maxlength="200"
                                                         class="col-xs-10 col-sm-5" value="{$dataObj.member_level_id}"/>
                            </div>
                            <div class="col-sm-2"><span class="help-inline middle"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2"><span class="help-inline middle" id="Member_member_name_em_">  </span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right" for="Member_member_sex">性别</label>

                            <div class="col-sm-7"><select class="form-control" id="Member_member_sex"
                                    ...
                                    <option value='0'{if $dataObj.member_sex eq "0"} selected="selected"{/if}>保密
                                    </option>
                                </select></div>
                            <div class="col-sm-2"><span class="help-inline middle" id="Member_member_sex_em_">  </span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right"
                            ...
                            <div class="col-sm-7"><input type="text" id="Member_member_birthday"
                                                         ...
                                                         class="col-xs-10 col-sm-5" value="{$dataObj.member_birthday}"/>
                            </div>
                            <div class="col-sm-2"><span class="help-inline middle"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7"><input type="text" id="Member_member_mobile"
                                                         ...
                                                         class="col-xs-10 col-sm-5" value="{$dataObj.member_mobile}"/>
                            </div>
                            <div class="col-sm-2"><span class="help-inline middle"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7"><input type="text" id="Member_member_nickname"
                                                         ...
                                                         class="col-xs-10 col-sm-5" value="{$dataObj.member_nickname}"/>
                            </div>
                            <div class="col-sm-2"><span class="help-inline middle"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7"><input type="text" id="Member_member_email"
                                                         ...
                                                         class="col-xs-10 col-sm-5" value="{$dataObj.member_email}"/>
                            </div>
                            <div class="col-sm-2"><span class="help-inline middle"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7"><input type="text" id="Member_member_avatar"
                                                         ...
                                                         class="col-xs-10 col-sm-5" value="{$dataObj.member_avatar}"/>
                            </div>
                            <div class="col-sm-2"><span class="help-inline middle"
