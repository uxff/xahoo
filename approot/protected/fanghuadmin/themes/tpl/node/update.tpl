<div class="page-content-area">
        <div class="page-header">
                                <h1> <a href="fanghuadmin.php?r=node">节点管理</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 编辑 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                        ...
                        <form class="form-horizontal" id="node-form" role="form" action="fanghuadmin.php?r=node/update&id={$model[$primaryKey]}" method="POST">
