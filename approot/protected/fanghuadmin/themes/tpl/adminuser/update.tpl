<div class="page-content-area">
        <div class="page-header">
                                <h1> <a href="fanghuadmin.php?r=adminUser">系统用户</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 编辑 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                        ...
                        <form class="form-horizontal" id="adminUser-form" role="form" action="fanghuadmin.php?r=adminUser/update&id={$model[$primaryKey]}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7"><input type="password" id="SysAdminUser_password" name="SysAdminUser[password]" size="60" maxlength="200" class="col-xs-10 col-sm-5" value="" /></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7"><select class="form-control" id="SysAdminUser_status" name="SysAdminUser[status]" style="width:120px;">   <option value="1"{if $dataObj.status eq "1"} selected="selected"{/if}>有效</option>   <option value="0"{if $dataObj.status eq "0"} selected="selected"{/if}>无效</option> <option value="99"{if $dataObj.status eq "99"} selected="selected"{/if}>删除</option></select></div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="SysRoleUser_role_id" name="SysRoleUser[role_id]" style="width:120px;">
                                {foreach from=$role item=item}
                                        <option value="{$item.id}" {if $dataObj.role.0.id==$item.id}selected{/if}>{$item.name}</option> 
                                {/foreach}  
                        </select>
                    </div>
                    <div class="col-sm-2"> <span class="help-inline middle" id="SysAdminUser_telephone_em_">  </span> </div>
