...
<div class="page-content-area">
        <div class="page-header">
                                <h1> <a href="backend.php?r=adminUser">系统用户</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 新增 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                        ...
                        <form class="form-horizontal"  id="adminUser-form" role="form" action="backend.php?r=adminUser/create" method="POST">
