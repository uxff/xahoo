    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" id="pointRule-form" role="form" action="backend.php?r=pointRule/create"
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="PointRule_rule_contribution">贡献分值</label>

                    <div class="col-sm-7"><input type="text" id="PointRule_rule_contribution" name="PointRule[rule_contribution]"
                                                 size="60" maxlength="200" class="col-xs-10 col-sm-5"
                                                 value="{$dataObj.rule_contribution}"/></div>
                    <div class="col-sm-2"><span class="help-inline middle" id="PointRule_rule_contribution_em_">  </span></div>
                </div>
                <div class="form-group">
