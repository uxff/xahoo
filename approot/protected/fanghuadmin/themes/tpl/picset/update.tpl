<div class="page-content-area">
        <div class="page-header">
            <h1> <a href="backend.php?r=picset">图库管理</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 编辑 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                        ...
                        <form class="form-horizontal" id="picset-form" role="form" action="backend.php?r=picset/update&id={$model[$primaryKey]}" method="POST">
