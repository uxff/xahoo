<div class="page-content-area">
        <div class="page-header">
                <h1> <a href="fanghuadmin.php?r=taskArticle">TaskArticle</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 查看详情 </small> </h1>
        </div>
        <!-- /.page-header -->
                ...
                <div class="col-xs-12"> 
                        ...
                        <div class="row">
                                <div class="col-xs-12">
                                        ...
                                        <div id="content">
                                                <h1>View TaskArticle #{$objModel.task_id}</h1>
