...
<div class="page-content-area">
        <div class="page-header">
                                <h1> <a href="backend.php?r=memberBrokerageLog">MemberBrokerageLog</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 新增 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                        ...
                        <form class="form-horizontal"  id="memberBrokerageLog-form" role="form" action="backend.php?r=memberBrokerageLog/create" method="POST">
