            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="searchContainer" style="display: {if $searchForm}block;{else}none;{/if}">
                        <form class="form-horizontal" id="taskBuilding-form" role="form" action="#" method="GET">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2"><span class="help-inline middle"
                                                            id="TaskBuilding_task_title_em_">  </span></div>
                            </div>
                            {*<div class="form-group">*}
                                {*<label class="col-sm-2 control-label no-padding-right"*}
                                       {*for="TaskBuilding_task_url">任务URL</label>*}

                                {*<div class="col-sm-7"><input type="text" id="TaskBuilding_task_url"*}
                                                             {*name="TaskBuilding[task_url]" size="60" maxlength="200"*}
                                                             {*class="col-xs-10 col-sm-5" value="{$dataObj.task_url}"/>*}
                                {*</div>*}
                                {*<div class="col-sm-2"><span class="help-inline middle"*}
                                                            {*id="TaskBuilding_task_url_em_">  </span></div>*}
                            {*</div>*}
                            {*<div class="form-group">*}
                                {*<label class="col-sm-2 control-label no-padding-right"*}
                                       {*for="TaskBuilding_task_img">任务配图</label>*}

                                {*<div class="col-sm-7"><input type="text" id="TaskBuilding_task_img"*}
                                                             {*name="TaskBuilding[task_img]" size="60" maxlength="200"*}
                                                             {*class="col-xs-10 col-sm-5" value="{$dataObj.task_img}"/>*}
                                {*</div>*}
                                {*<div class="col-sm-2"><span class="help-inline middle"*}
                                                            {*id="TaskBuilding_task_img_em_">  </span></div>*}
                            {*</div>*}
                            <div class="form-group">
                                ...
                                <div class="col-sm-7"><input type="text" id="TaskBuilding_building_name"
                                                             name="TaskBuilding[building_name]" size="60"
                                                             maxlength="200" class="col-xs-10 col-sm-5"
                                                             value="{$dataObj.building_name}"/></div>
                                <div class="col-sm-2"><span class="help-inline middle"
                                                            id="TaskBuilding_building_name_em_">  </span></div>
                            </div>
                            {*<div class="form-group">*}
                                {*<label class="col-sm-2 control-label no-padding-right"*}
                                ...
                                {*<div class="col-sm-7"><input type="text" id="TaskBuilding_building_address"*}
                                                             {*name="TaskBuilding[building_address]" size="60"*}
                                                             {*maxlength="200" class="col-xs-10 col-sm-5"*}
                                                             {*value="{$dataObj.building_address}"/></div>*}
                                {*<div class="col-sm-2"><span class="help-inline middle"*}
                            ...
                            {*<div class="form-group">*}
                                ...
                                {*<div class="col-sm-7"><input type="text" id="TaskBuilding_building_open_time"*}
                                                             {*name="TaskBuilding[building_open_time]" size="60"*}
                                                             {*maxlength="200" class="col-xs-10 col-sm-5"*}
                                                             {*value="{$dataObj.building_open_time}"/></div>*}
                                {*<div class="col-sm-2"><span class="help-inline middle"*}
                                                            {*id="TaskBuilding_building_open_time_em_">  </span></div>*}
                            {*</div>*}
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"
                                       for="TaskBuilding_building_price">楼盘价格</label>

                                <div class="col-sm-7"><input type="text" id="TaskBuilding_building_price"
                                                             name="TaskBuilding[building_price]" size="60"
                                                             maxlength="200" class="col-xs-10 col-sm-5"
                                                             value="{$dataObj.building_price}"/></div>
                                <div class="col-sm-2"><span class="help-inline middle"
                            ...
                            {*<div class="form-group">*}
                                ...
                                {*<div class="col-sm-7"><textarea id="TaskBuilding_building_detail"*}
                                                                {*name="TaskBuilding[building_detail]"*}
                                                                {*class="col-xs-10 col-sm-5"*}
                                                                {*placeholder="楼盘详情">{$dataObj.building_detail}</textarea>*}
                                {*</div>*}
                                {*<div class="col-sm-2"><span class="help-inline middle"*}
                            ...
                            {*<div class="form-group">*}
                                ...
                                {*<div class="col-sm-7"><input type="text" id="TaskBuilding_brokerage_max"*}
                                                             {*name="TaskBuilding[brokerage_max]" size="60"*}
                                                             {*maxlength="200" class="col-xs-10 col-sm-5"*}
                                                             {*value="{$dataObj.brokerage_max}"/></div>*}
                                {*<div class="col-sm-2"><span class="help-inline middle"*}
                                                            {*id="TaskBuilding_brokerage_max_em_">  </span></div>*}
                            {*</div>*}
                            {*<div class="form-group">*}
                                {*<label class="col-sm-2 control-label no-padding-right"*}
                                ...
                                {*<div class="col-sm-7"><input type="text" id="TaskBuilding_dividend_ratio"*}
                                                             {*name="TaskBuilding[dividend_ratio]" size="60"*}
                                                             {*maxlength="200" class="col-xs-10 col-sm-5"*}
                                                             {*value="{$dataObj.dividend_ratio}"/></div>*}
                                {*<div class="col-sm-2"><span class="help-inline middle"*}
                            ...
                            {*<div class="form-group">*}
                                ...
                                {*<div class="col-sm-2"><span class="help-inline middle"*}
                                                            {*id="TaskBuilding_point_amount_em_">  </span></div>*}
                            {*</div>*}
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"
                                       for="TaskBuilding_status">状态</label>
                                ...
                                <div class="col-sm-2"><span class="help-inline middle"
                                                            id="TaskBuilding_status_em_">  </span></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"
                                       for="TaskBuilding_flag">类型</label>

                                <div class="col-sm-7"><select class="form-control" id="TaskBuilding_flag"
                                                              name="TaskBuilding[flag]" style="width:120px;">
                                ...
                                <div class="col-sm-2"><span class="help-inline middle"
                                                            id="TaskBuilding_flag_em_">  </span></div>
                            </div>
                    ...
                    <div class="table-header">
                        ...
                        <span class="pull-right">
                                                        <a href="fanghuadmin.php?r=taskBuilding/create"
                            ...
                            {foreach from=$arrData key=i item=objModel}
                                <tr>
                                    ...
                                    {foreach from=$arrAttributeLabels key=attrId item=labelName}
                                        ...
                                        {elseif $attrId == 'building_detail'}
                                            <td style="overflow: hidden">{substr_replace($objModel.$attrId, '......', '18')}</td>
                                        {elseif $attrId == 'task_url'}
                                            <td style="overflow: hidden"><a href="{$objModel.$attrId}">查看任务</a></td>
                                        {else}
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs btn-group">
                                            <a href="fanghuadmin.php?r=taskBuilding/view&id={$objModel.$modelId}"
                                               class="btn btn-xs btn-info"> <i
                                                        class="ace-icon fa fa-search-plus bigger-120"></i>查看 </a>
                                            <a href="fanghuadmin.php?r=taskBuilding/update&id={$objModel.$modelId}"
                                               class="btn btn-xs btn-success"> <i
                                                        class="ace-icon fa fa-pencil bigger-120"></i>编辑 </a>
                                            <button onclick="delConfirm('fanghuadmin.php?r=taskBuilding/delete&amp;id={$objModel.$modelId}');"
