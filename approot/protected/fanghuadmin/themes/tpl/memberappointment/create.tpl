...
<div class="page-content-area">
        <div class="page-header">
                                <h1> <a href="fanghuadmin.php?r=memberAppointment">MemberAppointment</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 新增 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                        ...
                        <form class="form-horizontal"  id="memberAppointment-form" role="form" action="fanghuadmin.php?r=memberAppointment/create" method="POST">
