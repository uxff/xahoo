...
<div class="page-content-area">
  <div class="page-header">
    <h1> <a href="fanghuadmin.php?r=poster">海报管理</a> <small> <i class="ace-icon fa fa-angle-double-right"></i>新增公众号 </small> </h1>
    {*
  ...
  <div class="row">
    <div class="col-xs-12"> 
      <form class="form-horizontal"  id="poster_form" role="form" onsubmit="return check_form_two();" action="fanghuadmin.php?r=Accounts/Insert" method="POST"  autocomplete="off">
        <br /><br />
        <div class="box_base poster_baseinfo clearfix">
          <div class="col-xs-12">
            <div class="form-group col-xs-6">
              ...
              <div class="col-sm-8">
                <input type="text" id="accounts_name" name="poster[accounts_name]" size="60"  class="col-xs-10 col-sm-12" placeholder="输入公众号名称" value="{$poster.accounts_name}" />
              </div>
            ...
            <div class="form-group col-xs-6">
              ...
              <div class="col-sm-8">
                <input type="text" id="token" name="poster[token]" size="60"  class="col-xs-10 col-sm-12" placeholder="输入公众号的AppSecret" value="{$poster.token}" />
              </div>
        ...
        <div class="box_base poster_baseinfo clearfix">
          <div class="col-xs-12">
            <div class="form-group col-xs-6">
              ...
              <div class="col-sm-8">
                <input type="text" id="appid" name="poster[appid]" size="60"  class="col-xs-10 col-sm-12" placeholder="输入公众号的AppID" value="{$poster.appid}" />
              </div>
            ...
            <div class="form-group col-xs-6">
              ...
              <div class="col-sm-8">
                <input type="text" id="appsecret" name="poster[appsecret]" size="60"  class="col-xs-10 col-sm-12" placeholder="输入公众号的AppSecret" value="{$poster.appsecret}" />
              </div>
