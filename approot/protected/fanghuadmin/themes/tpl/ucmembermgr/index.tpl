...
<div class="page-header">
        <h1> <a href="fanghuadmin.php?r=ucMemberMgr">会员列表</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 列表</small> </h1>
</div>
<!-- /.page-header -->
        ...
        <form class="form-horizontal"  id="ucMemberMgr-form" role="form" action="#" method="GET">
            ...
            <div class="col-xs-12">
                ...
                <div class="form-group col-xs-3">
                    ...
                    <div class="col-xs-8">
                        <select class="form-control" id="fh_member_level" name="UcMember[fh_member_level]" style="width:120px;">   
                            <option value="" selected="selected">请选择</option> 
                            {foreach from=$levelList key=key item=item}
                            <option value="{$item.level_id}" {if $dataObj.fh_member_level eq $item.level_id} selected="selected"{/if}>{$item.title}</option>   
                            {/foreach}
                        </select>
                    </div>
                </div>
        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{$arrTotalInfo[$i].points_total}</td>
                    <td level={$arrTotalInfo[$i].level}>
						{if isset($levelList[$arrTotalInfo[$i].level])}
							{$levelList[$arrTotalInfo[$i].level]['title']} (LV{$arrTotalInfo[$i].level})
						{else}
							LV{$arrTotalInfo[$i].level}
						{/if}
                    </td>
                    ...
                    <td>
                        <div class="hidden-sm hidden-xs btn-group">
                            <a href="fanghuadmin.php?r=ucMemberMgr/view&id={$objModel.$modelId}" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-search-plus bigger-120"></i>查看 </a>
                            <a href="fanghuadmin.php?r=ucMemberMgr/update&id={$objModel.$modelId}" class="btn btn-xs btn-success"> <i class="ace-icon fa fa-pencil bigger-120"></i>编辑 </a>
                            <!--
                            <button onclick="delConfirm('fanghuadmin.php?r=ucMemberMgr/delete&amp;id={$objModel.$modelId}');" data-url="" class="btn btn-xs btn-danger"> <i class="ace-icon fa fa-trash-o bigger-120"></i>删除 </button>
                            -->
                        </div>
                        <div class="hidden-md hidden-lg">
                            <div class="inline position-relative">
                                ...
                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                    <li> <a href="fanghuadmin.php?r=ucMemberMgr/view&id={$objModel.$modelId}" class="tooltip-info" data-rel="tooltip" title="View"> <span class="blue"> <i class="ace-icon fa fa-search-plus bigger-120"></i> </span> </a> </li>
                                    <li> <a href="fanghuadmin.php?r=ucMemberMgr/update&id={$objModel.$modelId}" class="tooltip-success" data-rel="tooltip" title="Edit"> <span class="green"> <i class="ace-icon fa fa-pencil-square-o bigger-120"></i> </span> </a> </li>
                                    <li> <button onclick="delConfirm('fanghuadmin.php?r=ucMemberMgr/delete&amp;id={$objModel.$modelId}');" class="tooltip-error" data-rel="tooltip" title="Delete"> <span class="red"> <i class="ace-icon fa fa-trash-o bigger-120"></i> </span> </button> </li>
                                </ul>
                            </div>
                        </div>
                    </td>
