<div class="page-content-area">
        <div class="page-header">
            <h1> <a href="fanghuadmin.php?r=ucMemberMgr">会员列表</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 编辑 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                        ...
                        <form class="form-horizontal" id="ucMemberMgr-form" role="form" action="fanghuadmin.php?r=ucMemberMgr/update&id={$model[$primaryKey]}" method="POST">
