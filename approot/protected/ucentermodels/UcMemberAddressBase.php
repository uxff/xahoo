...
/**
 * This is the model class for table "uc_member_address".
 *
 * The followings are the available columns in table 'uc_member_address':
 * @property string $id
 ...
 */
class UcMemberAddressBase extends UCenterActiveRecord
{
	/**
...
//                           'condition' => 'status=1',
        ...
        */
        public function rules()
        {
                ...
                return array(
                        ...
                        array('province_id, city_id, county_id, member_mail_code, is_default', 'numerical', 'integerOnly'=>true),
                        ...
                        array('id, province_id, city_id, county_id, consignee_name, consignee_mobile, address, member_mail_code, member_id, create_time, update_time, is_default', 'safe', 'on'=>'search'),
                );
        }
       ...
       public function attributeLabels()
       {
        ...
        public function getBaseCDbCriteria() {
				...
				$criteria->compare('member_mail_code',$this->member_mail_code);
