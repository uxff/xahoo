<?php
class UcMemberBindSns extends UcMemberBindSnsBase
{
    const SNS_SOURCE_WECHAT = 1;
    const SNS_SOURCE_WEIBO  = 2;
    static $ARR_SNS_SOURCE = [
        self::SNS_SOURCE_WECHAT => '微信',
        self::SNS_SOURCE_WEIBO  => '微博',
    ];
         ...
         * @return UcMemberBindSns the static model class
         */
