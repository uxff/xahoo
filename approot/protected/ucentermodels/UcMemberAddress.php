<?php
class UcMemberAddress extends UcMemberAddressBase
{
	...
	public function relations() {
		$curRelations = array(
                    'province' => array(self::HAS_ONE, 'UcRegion', '', 'on' => 'province.sys_region_index = t.province_id'),
                    'city' => array(self::HAS_ONE, 'UcRegion', '', 'on' => 'city.sys_region_index = t.city_id'),
                    'county' => array(self::HAS_ONE, 'UcRegion', '', 'on' => 'county.sys_region_index = t.county_id'),
		);
	...
	public function mySearch()
	{
		...
		$criteria->order = 'is_default DESC,id DESC';
		//为$criteria新增设置
		...
		$list = $this->with('province', 'city', 'county')->findAll($criteria);
		$pages = array(
	 ...
	 * @return UcMemberAddress the static model class
	 */
