...
class PmMemberTotal extends CActiveRecord {
	public function tableName()
	{
		return 'pm_member_total';
	}
    /**
    ...
    public function mySearch() {
        ...
        $list = $this->with('province', 'city', 'county')->orderBy('t.last_modified DESC,t.house_id DESC')->findAll($criteria);
        $pages = array(
