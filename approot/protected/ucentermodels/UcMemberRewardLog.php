<?php
class UcMemberRewardLog extends UcMemberRewardLogBase
{
        ...
        public function relations() {
                $curRelations = array(
						'member' => array(self::HAS_ONE, 'UcMember','','on'=>'t.parent_id=member.member_id'),
                );
         ...
         * @return UcMemberRewardLog the static model class
         */
