...
/**
 * This is the model class for table "uc_member_point_rule".
 *
 * The followings are the available columns in table 'uc_member_point_rule':
 ...
 */
class UcMemberPointRuleBase extends UCenterActiveRecord
{
	/**
