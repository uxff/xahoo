...
class PmCarouselImgs extends PmCarouselImgsBase {
    ...
    public function relations() {
        $curRelations = array(
        //    'city' => array(self::HAS_ONE, 'SysRegion', '', 'on' => 'city.sys_region_index = t.house_city'),
         //   'county' => array(self::HAS_ONE, 'SysRegion', '', 'on' => 'county.sys_region_index = t.house_county'),
         //   'borrow' =>array(self::BELONGS_TO,'JdBorrow','','on'=>'borrow.project_id = t.house_id')
        );
     ...
     * @return FqHouse the static model class
     */
