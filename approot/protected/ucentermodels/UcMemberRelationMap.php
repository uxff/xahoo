<?php
class UcMemberRelationMap extends UcMemberRelationMapBase
{
        ...
        public function relations() {
                $curRelations = array(
					'member' => array(self::HAS_ONE, 'UcMember','','on'=>'t.member_id=member.member_id'),
                );
         ...
         * @return object
         */
        public function pagination($pageNo = 1, $pageSize = 5) {
         ...
         * @return UcMemberRelationMap the static model class
         */
