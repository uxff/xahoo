...
/**
 * This is the model class for table "uc_security_question".
 *
 * The followings are the available columns in table 'uc_security_question':
 * @property string $id
 ...
 */
class UcSecurityQuestionBase extends UCenterActiveRecord {

        /**
         * @return string the associated database table name
         */
        public function tableName() {
                return 'uc_security_question';
        }
