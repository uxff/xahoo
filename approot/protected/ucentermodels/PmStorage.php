<?php
class PmStorage extends PmStorageBase
{
        ...
        public function relations() {
                $curRelations = array(
		               'admin_user' => array(self::BELONGS_TO, 'PmSysAdminUser', 'admin_id'),
		               'product' => array(self::BELONGS_TO, 'PmProduct', 'product_id'),
                );
        ...
        public function softDelete() {
        	...
        	return 	$this->updateAll(array('status'=>0),$criteria);
        }
        /**
         * custom defined scope
        ...
        public function mySearch()
        {
               // @todo Please modify the following code to remove attributes that should not be searched.
                ...
                $criteria->order='storage_id DESC';
                //为$criteria新增设置
                ...
                $list = $this->with('admin_user','product')->findAll($criteria);
                $pages = array(
