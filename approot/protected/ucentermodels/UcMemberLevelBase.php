...
/**
 * This is the model class for table "uc_member_level".
 *
 * The followings are the available columns in table 'uc_member_level':
 ...
 */
class UcMemberLevelBase extends CActiveRecord
{
	/**
