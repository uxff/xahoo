	 ...
	 */
        ...
        */
        public function rules()
        {
                ...
                return array(
                        array('member_id, order_id, parent_id, degree, operate_type, status', 'numerical', 'integerOnly'=>true),
                        ...
                        array('log_id, member_id, order_id, order_numberid, parent_id, degree, reward_score, operate_type, description, reward_before, reward_after, status, source, create_time, last_modified', 'safe', 'on'=>'search'),
                );
        }
