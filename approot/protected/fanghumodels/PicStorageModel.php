<?php
class PicStorageModel extends PicStorageModelBase
{
    // 使用类型
    const USED_TYPE_BANNER = 1;
    const USED_TYPE_HOTARTICLE = 2;
    const USED_TYPE_TASK = 3;
    const USED_TYPE_CMS_CONTENT = 4;
    static $ARR_USED_TYPE = array(
        USED_TYPE_BANNER => 'banner 图库',
        USED_TYPE_HOTARTICLE => '热门推荐封面',
        USED_TYPE_TASK => '任务封面',
        USED_TYPE_CMS_CONTENT => '活动CMS内容上传图',
    );
         ...
         * @return PicStorageModel the static model class
         */
