...
/**
 * This is the model class for table "member_from_sina".
 *
 * The followings are the available columns in table 'member_from_sina':
 * @property string $uid
 ...
 */
class MemberFromSinaBase extends CActiveRecord
{
	/**
