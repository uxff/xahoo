<?php
class MemberFriendModel extends MemberFriendModelBase
{
    const FROM_INVITE = 1;

    const STATUS_COMMON_FRIEND  = 1;
    const STATUS_SPECIAL_FRIEND = 2;
    const STATUS_DELETED        = 100;
    const STATUS_BLACKLIST      = 101;
         ...
         * @return MemberFriendModel the static model class
         */
