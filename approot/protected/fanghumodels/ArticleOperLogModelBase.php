	 ...
	 */
        ...
        */
        public function rules()
        {
                ...
                return array(
                        ...
                        array('old_status, new_status, has_online_status, admin_uid', 'numerical', 'integerOnly'=>true),
                        array('article_id', 'length', 'max'=>10),
                        array('admin_name', 'length', 'max'=>32),
                        array('create_time, oper_time', 'safe'),
                                        // The following rule is used by search().
                        // @todo Please remove those attributes that should not be searched.
                        array('id, article_id, old_status, new_status, has_online_status, admin_uid, admin_name, create_time, last_modified', 'safe', 'on'=>'search'),
                );
        }
       ...
       public function attributeLabels()
       {
        ...
        public function getBaseCDbCriteria() {
				...
				$criteria->compare('t.admin_uid',$this->admin_uid);
