...
/**
 * This is the model class for table "member_to_task".
 *
 * The followings are the available columns in table 'member_to_task':
 * @property string $id
 ...
 */
class MemberToTaskBase extends CActiveRecord {

        /**
         * @return string the associated database table name
         */
        public function tableName() {
                return 'member_to_task';
        }
