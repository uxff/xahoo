...
//                    'tasks' => array(self::MANY_MANY, 'PointTask', 'member_to_task(member_id, task_id)', 'on'=>'tasks_tasks.status=1'),
                    'taskarticles' => array(self::MANY_MANY, 'TaskArticle', 'member_to_taskarticle(member_id, task_id)'),
                    'taskarbuildings' => array(self::MANY_MANY, 'TaskBuilding', 'member_to_taskbuilding(member_id, task_id)'),
                    'favorates' => array(self::MANY_MANY, 'PointTask', 'member_favorite(member_id, task_id)'),
                    'default_address' => array(self::HAS_ONE, 'MemberAddress', 'member_id', 'on' => 'default_address.is_default=1'),
                );
