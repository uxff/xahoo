...
/**
 * This is the model class for table "member_total".
 *
 * The followings are the available columns in table 'member_total':
 ...
 */
class MemberTotalBase extends CActiveRecord {
