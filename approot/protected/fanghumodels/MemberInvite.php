<?php
class MemberInvite extends MemberInviteBase
{
        ...
        public function relations() {
                $curRelations = array(
					'task_building' => array(self::BELONGS_TO, 'TaskBuilding', 'task_building_id'),
                );
         ...
         * @return MemberInvite the static model class
         */
