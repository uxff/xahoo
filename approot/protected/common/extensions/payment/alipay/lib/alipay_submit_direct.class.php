...
class AlipaySubmitDirect {

	var $alipay_config;

	const ALIPAY_GATEWAY_SANDBOX = 'https://openapi.alipaydev.com/gateway.do?';
	/**
	 *支付宝网关地址（新）
	 */
	...
	function __construct($alipay_config){
		...
		// debug
		if ($this->alipay_config['sandbox']) {
			$this->alipay_gateway_new = self::ALIPAY_GATEWAY_SANDBOX;
		}
	}
	
    function AlipaySubmitDirect($alipay_config) {
	...
	function buildPageUrl($para_temp) {
		//待请求参数数组
