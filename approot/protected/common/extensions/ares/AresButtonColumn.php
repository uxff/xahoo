 ...
 * @since 1.1
 */
class AresButtonColumn extends CGridColumn
{
	/**
	...
	protected function renderDataCellContent($row,$data)
	{
		...
		*/
		...
		<div class="hidden-sm hidden-xs btn-group"> 
			<a href="'. $this->viewButtonUrl .'&id='.$data->primaryKey .'" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-search-plus bigger-120"></i>查看 </a> 
			<a href="'. $this->updateButtonUrl .'&id='.$data->primaryKey .'" class="btn btn-xs btn-success"> <i class="ace-icon fa fa-pencil bigger-120"></i>编辑 </a> 
			<a class="btn btn-xs btn-danger"> <i class="ace-icon fa fa-trash-o bigger-120"></i>删除 </a> </div>
		<div class="hidden-md hidden-lg">
          <div class="inline position-relative">
            ...
            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
              <li> <a href="'. $this->viewButtonUrl .'&id='.$data->primaryKey .'" class="tooltip-info" data-rel="tooltip" title="" data-original-title="View"> <span class="blue"> <i class="ace-icon fa fa-search-plus bigger-120"></i> </span> </a> </li>
              <li> <a href="'. $this->updateButtonUrl .'&id='.$data->primaryKey .'" class="tooltip-success" data-rel="tooltip" title="" data-original-title="Edit"> <span class="green"> <i class="ace-icon fa fa-pencil-square-o bigger-120"></i> </span> </a> </li>
              <li> <a href="'. $this->deleteButtonUrl .'&id='.$data->primaryKey .'" class="tooltip-error" data-rel="tooltip" title="" data-original-title="Delete"> <span class="red"> <i class="ace-icon fa fa-trash-o bigger-120"></i> </span> </a> </li>
            </ul>
          </div>
        </div>
        ';
