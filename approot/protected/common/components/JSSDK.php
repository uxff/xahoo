...
class JSSDK {
        ...
        public function getSignPackage($url = '') {
                ...
                $url = $url ? $url : $protocal."$_SERVER[SERVER_NAME]$_SERVER[REQUEST_URI]";
                $timestamp = time();
                ...
                //Yii::log('jssdk sign str:'.$string.' signature='.$signature, 'error', __METHOD__);
        ...
        private function httpGet($url) {
                ...
                //Yii::log('jssdk get url='.$url.'     --------res='.$res, 'error', __METHOD__);
