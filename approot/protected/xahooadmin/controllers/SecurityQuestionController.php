...
class SecurityQuestionController extends Controller
{
    ...
    public function actionView($id) {
        ...
        $this->smartyRender('securityquestion/view.tpl', $arrRender);
    }
    ...
    public function actionCreate() {
        ...
        $this->smartyRender('securityquestion/create.tpl', $arrRender);
    }
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['SecurityQuestion'])) {
                $updateModel->attributes = $_POST['SecurityQuestion'];
                if ($updateModel->save()) {
        ...
        $this->smartyRender('securityquestion/update.tpl', $arrRender);
    }
    ...
    public function actionIndex($keyword='', $pageNo=1, $pageSize=10) {
        ...
        if (isset($_GET['SecurityQuestion'])) {
                $searchForm = 1;
                $model->attributes = $_GET['SecurityQuestion'];
        }
        ...
        //smarty render
        $this->smartyRender('securityquestion/index.tpl', $arrRender);
    }
    ...
    public function actionAdmin() {
        $dataProvider = new CActiveDataProvider('SecurityQuestion');
        ...
        $this->smartyRender('securityquestion/admin.tpl', $arrRender);
    }
    ...
    public function loadModel($id) {
        $model = SecurityQuestion::model()->findByPk($id);
        if ($model === null)
     ...
     * @param SecurityQuestion $model the model to be validated
     */
