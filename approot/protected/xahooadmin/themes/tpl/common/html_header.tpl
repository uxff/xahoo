...
<html lang="en">
        <head>
                ...
                <!--chosen-->
                <link rel="stylesheet" href="{$resourcePath}/css/chosen.css" />

                <!--data-->
                <link rel="stylesheet" href="{$resourcePath}/css/daterangepicker.css" />
                <link rel="stylesheet" href="{$resourcePath}/css/datepicker.css" />
                <link rel="stylesheet" href="{$resourcePath}/css/datepicker.css" />
				...
				<link rel="stylesheet" href="resource/backend/css/base.css" />
