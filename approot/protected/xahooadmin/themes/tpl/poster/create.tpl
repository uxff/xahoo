...
<div class="page-content-area">
  <div class="page-header">
    <h1> <a href="backend.php?r=poster">海报管理</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 海报配置 </small> </h1>
    {*
  ...
  <div class="row">
    <div class="col-xs-12"> 
      <form class="form-horizontal"  id="poster_form" role="form" onsubmit="return check_form_two();" action="backend.php?r=Poster/Insert" method="POST"  autocomplete="off">
        <br />
