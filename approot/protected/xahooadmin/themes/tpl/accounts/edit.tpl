...
<div class="page-content-area">
  ...
  <div class="row">
    <div class="col-xs-12"> 
      <form class="form-horizontal"  id="poster_form" role="form" onsubmit="return check_form_two();" action="backend.php?r=mpaccounts/update&id={$accountsData['id']}" method="POST"  autocomplete="off">
        <br /><br />        
