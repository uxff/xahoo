...
class OAuthController extends Controller
{
    ...
    public function actionTest()
    {
        ...
        $o = new WeichatAuth();
        $weichat_url = $o->get_authorize_url('http://testhifang..fangfull.com/ucenter.php?r=oauth/login&ft=weichat');
    ...
    public function actionLogin()
    {
        ...
        if (isset($_REQUEST['code'])) {
            ...
            $keys['redirect_uri'] = 'testhifang.fangfull.com/ucenter.php?r=OAuth/login&ft=weibo';
            try {
