<?php
class UcMemberContributeLog extends UcMemberContributeLogBase
{
        ...
        public function mySearch()
        {
               // @todo Please modify the following code to remove attributes that should not be searched.
                ...
                if(!empty(Yii::app()->params['pageSize'])){
                    Yii::app()->params['pageSize']=15;//用户中心显示15条数据
                }
                
                $pager->pageSize = !empty(Yii::app()->params['pageSize'])?Yii::app()->params['pageSize']:10;
                $pager->pageVar = 'page_no'; //修改分页参数，默认为page
         ...
         * @return UcMemberContributeLog the static model class
         */
