...
/**
 * This is the model class for table "uc_member_favorite".
 *
 * The followings are the available columns in table 'uc_member_favorite':
 ...
 */
class UcMemberFavoriteBase extends UCenterActiveRecord {

        /**
         * @return string the associated database table name
         */
        public function tableName() {
                return 'uc_member_favorite';
        }
        ...
        public function rules() {
                ...
                return array(
                    ...
                    array('task_source', 'length', 'max' => 25),
                    array('create_time, last_modified', 'safe'),
                    // The following rule is used by search().
                    // @todo Please remove those attributes that should not be searched.
                    array('favorite_id, task_id, task_type, task_source, member_id, status, create_time, last_modified', 'safe', 'on' => 'search'),
                );
        }
        ...
        public function getBaseCDbCriteria() {
                ...
                $criteria->compare('task_source', $this->task_source, true);
