...
class UcMemberToSecurityQuestion extends UcMemberToSecurityQuestionBase {
        ...
        public function relations() {
                $curRelations = array(
                    'question_1' => array(self::BELONGS_TO, 'UcSecurityQuestion', 'security_question_id_1'),
                    'question_2' => array(self::BELONGS_TO, 'UcSecurityQuestion', 'security_question_id_2'),
                    'question_3' => array(self::BELONGS_TO, 'UcSecurityQuestion', 'security_question_id_3'),
                );
         ...
         * @return UcMemberToSecurityQuestion the static model class
         */
