...
/**
 * This is the model class for table "uc_member_to_security_question".
 *
 * The followings are the available columns in table 'uc_member_to_security_question':
 * @property string $id
 ...
 */
class UcMemberToSecurityQuestionBase extends UCenterActiveRecord {

        /**
         * @return string the associated database table name
         */
        public function tableName() {
                return 'uc_member_to_security_question';
        }
