...
/**
 * This is the model class for table "uc_member_security_question".
 *
 * The followings are the available columns in table 'uc_member_security_question':
 * @property string $id
 ...
 */
class UcMemberSecurityQuestionBase extends UCenterActiveRecord {

        /**
         * @return string the associated database table name
         */
        public function tableName() {
                return 'uc_member_security_question';
        }
        ...
        public function rules() {
                ...
                return array(
                    ...
                    array('id, member_id, security_question_id_1, security_question_id_2, security_question_id_3, answer_1, answer_2, answer_3, status, create_time, last_modified', 'safe', 'on' => 'search'),
                );
        }
