...
<div class="page-content-area">
        <div class="page-header">
                <h1> <a href="index.php?r=profile">UcMember</a> <small> <i class="ace-icon fa fa-angle-double-right"></i> 新增 </small> </h1><br />
        ...
        <div class="row">
                <div class="col-xs-12"> 
                        ...
                        <form class="form-horizontal"  id="profile-form" role="form" action="index.php?r=profile/create" method="POST">
