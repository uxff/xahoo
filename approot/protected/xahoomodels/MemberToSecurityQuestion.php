<?php
class MemberToSecurityQuestion extends MemberToSecurityQuestionBase
{
        ...
        public function relations() {
                $curRelations = array(
                    'question_1'=>array(self::BELONGS_TO, 'SecurityQuestion', 'security_question_id_1'),
                    'question_2'=>array(self::BELONGS_TO, 'SecurityQuestion', 'security_question_id_2'),
                    'question_3'=>array(self::BELONGS_TO, 'SecurityQuestion', 'security_question_id_3'),
                );
         ...
         * @return MemberToSecurityQuestion the static model class
         */
