...
class MemberToTask extends MemberToTaskBase {
        ...
        public function relations() {
                $curRelations = array(
                    'task_article' => array(self::HAS_ONE, 'TaskArticle', '', 'on' => 't.task_id=task_article.task_id'),
                    'task_building' => array(self::HAS_ONE, 'TaskBuilding', '', 'on' => 't.task_id=task_building.task_id'),
                );
         ...
         * @return MemberToTask the static model class
         */
