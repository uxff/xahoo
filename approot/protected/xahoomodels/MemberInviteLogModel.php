<?php
class MemberInviteLogModel extends MemberInviteLogModelBase
{
    const INVITE_TYPE_MOBILE = 1;
    const INVITE_TYPE_EMAIL  = 2;
    const INVITE_STATUS_AGREE       = 1;
    const INVITE_STATUS_REJECTED    = 2;
         ...
         * @return MemberInviteLogModel the static model class
         */
