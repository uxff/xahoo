...
/**
 * This is the model class for table "fh_poster_log".
 *
 * The followings are the available columns in table 'fh_poster_log':
 * @property integer $id
 ...
 */
class FhPosterLogModelBase extends CActiveRecord
{
	/**
