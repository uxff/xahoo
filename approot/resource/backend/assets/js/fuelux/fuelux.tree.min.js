...
(function ($, undefined) {
    ...
    var Tree = function (element, options) {
        ...
        $(this.options.b).on("click", ".tree-item", $.proxy(function (ev) {
            this.selectItem(ev.currentTarget)
        }, this));
        $(this.options.b).on("click", ".tree-folder-header", $.proxy(function (ev) {
            this.selectFolder(ev.currentTarget)
        }, this));
        this.render()
        this.tree2box=this.options.b
    };
    Tree.prototype = {
        constructor: Tree,
        render: function (){
