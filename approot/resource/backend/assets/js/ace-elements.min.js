...
function (e) {
    ...
    e.fn.ace_tree = function (a) {
        return t = e.extend({}, t, a), this.each(function () {
            ...
            // console.log(t.b)
            var treebox=e(t.b);
            // if(e('.tree-folder>.tree-folder-header')){
            treebox.html('<div class="tree-folder" style="display:none;">				<div class="tree-folder-header">					<i class="' + ace.vars.icon + t["close-icon"] + '"></i>					<div class="tree-folder-name"></div>				</div>				<div class="tree-folder-content"></div>				<div class="tree-loader" style="display:none"></div>			</div>			<div class="tree-item" style="display:none;">				' + (null == t["unselected-icon"] ? "" : '<i class="' + ace.vars.icon + t["unselected-icon"] + '"></i>') + '				<div class="tree-item-name"></div>			</div>'),
            treebox.addClass(1 == t.selectable ? "tree-selectable" : "tree-unselectable"), 
