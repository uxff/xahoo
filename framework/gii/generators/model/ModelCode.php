...
class ModelCode extends CCodeModel {
        ...
        public function prepare() {
                //初始化model生成目录 在config/main.php中的params中配置
                $this->modelPath = empty(Yii::app()->params['giiPath']['model']) ? $this->modelPath : Yii::app()->params['giiPath']['model'];
                ...
                foreach ($tables as $table) {
                        ...
                        $this->files[] = new CCodeFile(
                                Yii::getPathOfAlias($this->modelPath) . '/' . $className . 'Base.php', $this->render($templatePath . '/modelBase.php', $params)
                        );
                }
        }
