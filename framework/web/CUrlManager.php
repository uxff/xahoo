...
class CUrlManager extends CApplicationComponent {
         ...
         * be in lower case.
         */
        public $caseSensitive = true; //develope :大小写不敏感
        /**
        ...
        public function parseUrl($request) {
                // modified by liutao@fangfull.com
                // CUrlManager支持兼容path、get两种URL同时可以访问
                // 原始代码如下
                /* if ($this->getUrlFormat() === self::PATH_FORMAT) { */
                if ($this->getUrlFormat() === self::PATH_FORMAT && !isset($_GET[$this->routeVar])) {
